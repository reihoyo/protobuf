...
def cc_proto_compile_and_link(ctx, deps, sources, headers, disallow_dynamic_library = None, feature_configuration = None, alwayslink = False, **kwargs):
    ...
    (compilation_context, compilation_outputs) = cc_common.compile(
        ...
        # as in b/64963386.
        #        code_coverage_enabled = False, # TODO - expose partially
        **kwargs
    )
    ...
    return CcInfo(
        ...
        #        debug_context = cc_common.merge_debug_context(  # TODO expose
        #           [cc_common.create_debug_context(compilation_outputs)] +
        #            [dep[CcInfo].debug_context() for dep in deps if CcInfo in dep], # TODO expose
        #        ),
    ), libraries, []  #compilation_outputs.temps() # TODO expose
